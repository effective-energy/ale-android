...
public class WalletsAdapter extends BaseAdapter {
    ...
    public WalletsAdapter(Context context, List<Wallet> elements) {
        this.context = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = LayoutInflater.from(context).inflate(R.layout.spinner_item, null);
        TextView tvTitle = (TextViewFont) v.findViewById(R.id.text1);
